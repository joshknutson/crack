...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <title>CRACK (Coldfusion Rapid Application Construction Kit)</title>
    ...
    <body>
		<div id="container">
			...
			<div id="cfWindowContent">
				...
				<cfif NOT DirectoryExists( ExpandPath( "..#slash##datasource##slash#app#slash#helpers#slash#layouts" ) )>
				    <cfdirectory action="create" directory="#rootPath##slash##datasource##slash#app#slash#helpers#slash#layouts">
				...
				<cfif NOT DirectoryExists( ExpandPath( "..#slash##datasource##slash#app#slash#views#slash##table#" ) )>
					...
					#table# directory was created.<br />
				<cfelse>
					#table# directory already existed.<br />
				</cfif>
				...
				<cfset generateLayout = codeGenerator.generateLayout() />
				<cfset generateCSS = codeGenerator.generateCSS() />
				<cfset generateController = codeGenerator.generateModelController() />
				<cfset generateForm = codeGenerator.generateForm() />
				<cfset generateDataTable = codeGenerator.generateDataTable() />
				<cfset generateDefault = codeGenerator.generateDefault() />
				<cfset generateApplicationCFC = codeGenerator.generateApplicationCFC() />
				<cfset generateHelperNavigation = codeGenerator.generateHelperNavigation() />
				...
				<cfif FileExists( ExpandPath( "..#slash##datasource##slash#app#slash#helpers#slash#layouts#slash#layout.cfm" ) ) AND ifExists EQ "skip">
				...
				<cfelse>
					<cfif NOT FileExists( ExpandPath( "..#slash##datasource##slash#app#slash#helpers#slash#layouts#slash#layout.cfm" ) )>
				    	<cfoutput>#slash##datasource##slash#app#slash#views#slash#layouts#slash#layout.cfm has been created.<br /></cfoutput>
					<cfelse>
						<cfoutput>#slash##datasource##slash#app#slash#helpers#slash#layouts#slash#layout.cfm existed and was overwritten.<br /></cfoutput>
					</cfif>
					<cfset generateLayout =  replaceList(generateLayout,"<%,%,^","<,##,%") />
					<cffile action="write" file="#rootPath##slash##datasource##slash#app#slash#helpers#slash#layouts#slash#layout.cfm" output="#generateLayout#" nameconflict="overwrite">
				</cfif>

				<cfif FileExists( ExpandPath( "..#slash##datasource##slash#assets#slash#css#slash#css_#datasource#.css" ) ) AND ifExists EQ "skip">
					<cfoutput>#slash##datasource##slash#assets#slash#css#slash#layouts#slash#css_#datasource#.css already existed and was skipped.<br /></cfoutput>
				<cfelse>
					<cfif NOT FileExists( ExpandPath( "..#slash##datasource##slash#assets#slash#css#slash#css_#datasource#.css" ) )>
				    	<cfoutput>#slash##datasource##slash#assets#slash#css#slash#css_#datasource#.css has been created.<br /></cfoutput>
					<cfelse>
						<cfoutput>#slash##datasource##slash#assets#slash#css#slash#css_#datasource#.css existed and was overwritten.<br /></cfoutput>
					</cfif>
					<cfset generateCSS =  replaceList(generateCSS,"<%,%,^","<,##,%") />
					<cffile action="write" file="#rootPath##slash##datasource##slash#assets#slash#css#slash#css_#datasource#.css" output="#generateCSS#" nameconflict="overwrite">
				</cfif>
